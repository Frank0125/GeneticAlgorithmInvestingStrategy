...
def arg_handler():
    ...
    parser.add_argument("--ps", type=int, choices=[100], help="Population Size")
    parser.add_argument("--mr", type=int, choices=[5, 25, 50, 75], help="Mutation Rate")
    parser.add_argument("--rp", type=int,choices=[50], help="Ranking Selection")
    parser.add_argument("--gens", type=int,choices=[10, 20, 30, 50, 100], help="Generations")

    args = parser.parse_args()
    return args if args.mr and args.gens else None
