...
class InvestStrategy():
    def __init__(self, stock_gene = TYPE_GENES[0], risk_gene = RISK_GENES[0], schedule = 0): #all parameters are genes
        ...
        # self.total_risk = self.chosen_stock.get_risk() + self.extra_risk.get_added_risk() #! no longer need
